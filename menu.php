...
<!-- Meta SEO Tags -->
  ...
  <title>Menu | The Roots Restaurant - Authentic Ugandan Cuisine</title>
...
<body>
  ...
  <div class="wrapper">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12">
            ...
            <h1 class="pagetitle__heading">The Roots Menu</h1>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Roots Menu</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
            <div class="heading heading-layout1 text-center mb-40">
              ...
              <h2 class="heading__title">Featured Dishes</h2>
    ...
    <!-- ========================
       BREAKFAST MENU
    =========================== -->
    <section class="text-banner text-banner-layout2 text-center bg-overlay bg-overlay-gradient bg-parallax" id="breakfast">
      <div class="bg-img"><img src="static/images/backgrounds/5.jpg" alt="background"></div>
      <div class="divider-shape"></div>
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12">
            <span class="banner__subtitle">Starts At 7:00 AM</span>
    ...
    <section class="menu-layout1 pb-80">
      ...
      <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6">
            <div class="menu-wrapper">
              <div class="menu-item">
                <h4 class="menu__item-title">Toast</h4>
                <span class="menu__item-price">25,000 Ugx</span>
                <p class="menu__item-desc">Brown or white bread toast served with butter</p>
              </div>
              <div class="menu-item">
                <h4 class="menu__item-title">Fruit Salad</h4>
                <span class="menu__item-price">15,000 Ugx</span>
                <p class="menu__item-desc">With an option of low-fat yoghurt</p>
              </div>
              <div class="menu-item">
                <h4 class="menu__item-title">Fruit Platter</h4>
                <span class="menu__item-price">20,000 Ugx</span>
                <p class="menu__item-desc">Seasonal fruit</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12 col-md-12 col-lg-6">
            <div class="menu-wrapper">
              <div class="menu-item">
                <h4 class="menu__item-title">Vegetable Platter</h4>
                <span class="menu__item-price">20,000 Ugx</span>
                <p class="menu__item-desc">Steamed Seasonal vegetables</p>
              </div>
              <div class="menu-item">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12">
            ...
            <h2 class="banner__title">Our Soups</h2>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-6">
            ...
            <div class="menu-item">
              ...
              <span class="menu__item-price">20,000 Ugx</span>
              <p class="menu__item-desc">Fresh oyster mushroom steamed in vegetable stock for your refreshment </p>
            </div>
            <div class="menu-item">
              <h4 class="menu__item-title">Cream of Mushroom</h4>
              <span class="menu__item-price">20,000 Ugx</span>
              <p class="menu__item-desc">Fresh oyster mushroom cooked in vegetable stock with cream to enjoy intense mushroom flavour with every mouthful </p>
            </div>
          ...
          <div class="col-sm-12 col-md-12 col-lg-6">
          <div class="menu-item">
              <h4 class="menu__item-title">Clear Vegetable</h4>
              <span class="menu__item-price">20,000 Ugx</span>
              <p class="menu__item-desc">A mix of fresh garden vegetables to give you the immunity boost you need </p>
            </div>
            <div class="menu-item">
              <h4 class="menu__item-title">Cream of Pumpkin</h4>
              <span class="menu__item-price">20,000 Ugx</span>
              <p class="menu__item-desc">Blended in vegetable stock and cream for great taste </p>
            </div>
          </div>
    ...
    <!-- ========================
       MAIN DISHES
    =========================== -->
    <section class="text-banner text-banner-layout2 text-center bg-overlay bg-overlay-gradient bg-parallax" id="mains">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12">
            <span class="banner__subtitle">Don’t Miss</span>
            <h2 class="banner__title">Main Dishes</h2>
          </div>
        </div>
      </div>
    </section>
